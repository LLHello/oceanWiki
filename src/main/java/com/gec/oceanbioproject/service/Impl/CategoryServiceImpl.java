...
import com.gec.oceanbioproject.entity.Category;
import com.gec.oceanbioproject.mapper.CategoryMapper;
...
//创建分页对象
        ...
        List<CategoryQueryResp> resps = CopyUtil.copyList(page.getRecords(),
                CategoryQueryResp.class);
//创建返回对象
